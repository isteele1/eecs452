...
volatile double attack_interval_ms = 25;
/* USER CODE END PV */
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  // ATTACKER sends jamming signal every 25ms
	  if (ATTACK_TYPE != NONE){
